...
const openStream = __webpack_require__(8);
const playVideo = __webpack_require__(3);
const Peer = __webpack_require__(9);
const uid = __webpack_require__(15);
const $ = __webpack_require__(16);
const config = {host: 'streamlinhrtc.herokuapp.com',port: 443,secure:true,key:'peerjs'};
function getPeer() {
	const id = uid(10);
	$('#peer-id').append(id);
	return id;
